...
{
       0,   115,   115,   118,   120,   121,   124,   126,   128,   138,
     146,   149,   151,   154,   163,   172,   181,   190,   198,   201,
     207,   210
};
#endif
...
{
  "$end", "error", "$undefined", "TOK_LBRACE", "TOK_COUT",
  "TOK_STREAMOUTPUT", "TOK_RBRACE", "TOK_RETURN", "TOK_ADD", "TOK_SUB",
  "TOK_MUL", "TOK_DIV", "TOK_NEG", "TOK_LPAREN", "TOK_RPAREN", "TOK_SEMI",
  "TOK_LETTER", "TOK_EQUALS", "TOK_UINT", "TOK_TYPE", "TOK_IDENTIFIER",
  "$accept", "program", "function", "stmt", "stmt_list", "expr", "value",
  "number", YY_NULLPTR
};
#endif
...
{
      -9,     3,    36,    -9,    46,    -1,    -6,    -6,    -9,    -3,
      -9,    -9,    10,    51,    -9,     6,    -9,     4,    -6,    12,
      -9,    -8,    -9,    -6,    -6,    -6,    -6,    14,    -9,    -9,
      19,    -9,    21,    -6,    -9,    -9,    -9,    -9,    -9,    33,
      22,    46,    -9,    26,    -9
};
...
{
       5,     0,     2,     1,     0,     0,     0,     0,    21,     0,
      19,     3,     0,    18,    20,     0,    11,     0,     0,     0,
      17,     0,     6,     0,     0,     0,     0,     0,    10,    12,
       0,     7,     0,     0,    13,    14,    15,    16,     9,     0,
       0,     0,     8,     0,     4
};
...
{
      11,    19,    20,     3,    18,    32,     7,     4,     5,    33,
      28,     6,     8,    30,    10,    29,     7,    21,    34,    35,
      36,    37,     8,    15,    10,    22,    27,    31,    40,     4,
       5,    33,    44,     6,    38,    39,    41,    42,     7,     4,
       5,    29,    43,     6,     8,    15,    10,     0,     7,     4,
       5,     0,     0,     6,     8,     9,    10,     0,     7,    23,
      24,    25,    26,     0,     8,    15,    10
};

static const yytype_int8 yycheck[] =
{
       2,     6,     7,     0,     5,    13,    12,     3,     4,    17,
       6,     7,    18,    18,    20,    17,    12,    20,    23,    24,
      25,    26,    18,    19,    20,    15,    20,    15,    33,     3,
       4,    17,     6,     7,    15,    14,     3,    15,    12,     3,
       4,    43,    41,     7,    18,    19,    20,    -1,    12,     3,
       4,    -1,    -1,     7,    18,    19,    20,    -1,    12,     8,
       9,    10,    11,    -1,    18,    19,    20
};
...
{
       0,    22,    23,     0,     3,     4,     7,    12,    18,    19,
      20,    24,    26,    27,    28,    19,    24,    25,     5,    26,
      26,    20,    15,     8,     9,    10,    11,    20,     6,    24,
      26,    15,    13,    17,    26,    26,    26,    26,    15,    14,
      26,     3,    15,    25,     6
};
...
#line 129 "parser.y"
    {
        insertSymbol((char*)(yyvsp[-4].string), (char*)(yyvsp[-3].string), symbolTableProxy);
...
#line 202 "parser.y"
    {
        ...
        parserStackPush(parserStack, string_type((yyvsp[0].string)));
    }
#line 1545 "y.tab.c"
    break;
...
#line 211 "parser.y"
    {
        ...
        parserStackPush(parserStack, int_type((yyvsp[0].number)));
    }
#line 1554 "y.tab.c"
    break;
